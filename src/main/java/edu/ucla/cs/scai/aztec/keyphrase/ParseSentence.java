...
public class ParseSentence {
    ...
    public static void main(String[] args) throws IOException, JWNLException{
        ...
        String infile = "src/main/data/phraseList_Chi_v2.txt";
        String senfile = "src/main/data/parsedSentence_for_train_Chi_v2.txt";
        String outfile = "src/main/data/parsedSentence_for_train_Chi_v3.txt";
